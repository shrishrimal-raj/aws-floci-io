# 037 - ELB v2 (ALB/NLB) (Spec)

> Load balancers. ALB for HTTP, NLB for TCP/UDP.
...
## What it is
ELB v2 (ALB/NLB) is an AWS networking service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to ELB v2 (ALB/NLB)
- Use case 2 specific to ELB v2 (ALB/NLB)
- Use case 3 specific to ELB v2 (ALB/NLB)
...
export const client = new ElasticLoadBalancingV2Client(awsDefaults());
```
