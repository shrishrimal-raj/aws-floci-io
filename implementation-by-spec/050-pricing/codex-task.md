# Codex CLI task - Pricing API

You are completing the `implementation-by-spec/050-pricing/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to Pricing API.
...
docker compose up -d
pnpm install
cd implementation-by-spec/050-pricing
pnpm setup
pnpm test
```
