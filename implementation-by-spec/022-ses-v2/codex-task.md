# Codex CLI task - SES v2

You are completing the `implementation-by-spec/022-ses-v2/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to SES v2.
