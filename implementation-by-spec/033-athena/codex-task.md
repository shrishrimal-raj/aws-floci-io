# Codex CLI task - Athena

You are completing the `implementation-by-spec/033-athena/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to Athena.
