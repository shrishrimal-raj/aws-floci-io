# Codex CLI task - Transfer Family

You are completing the `implementation-by-spec/046-transfer-family/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to Transfer Family.
...
docker compose up -d
pnpm install
cd implementation-by-spec/046-transfer-family
pnpm setup
pnpm test
```
