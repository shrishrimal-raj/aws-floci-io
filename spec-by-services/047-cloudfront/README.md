...
> CDN. Origins, behaviors, signed URLs, OAC.
...
## What it is
CloudFront is an AWS networking service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to CloudFront
- Use case 2 specific to CloudFront
- Use case 3 specific to CloudFront
...
export const client = new CloudFrontClient(awsDefaults());
```
