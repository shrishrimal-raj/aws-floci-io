# Codex CLI - Phase 07: DevOps & Delivery

Implement the full phase as described in `spec-by-phases/phase-07-devops-delivery/README.md`.
...
2. Build the major project: **Self-Service Deploy Platform**.
