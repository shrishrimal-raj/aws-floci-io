# Codex CLI task - CloudWatch Metrics

You are completing the `implementation-by-spec/020-cloudwatch-metrics/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to CloudWatch Metrics.
