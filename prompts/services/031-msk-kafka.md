# Codex CLI task - MSK (Kafka)

You are completing the `implementation-by-spec/031-msk-kafka/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to MSK (Kafka).
