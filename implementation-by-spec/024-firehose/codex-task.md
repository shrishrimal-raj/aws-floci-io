# Codex CLI task - Firehose

You are completing the `implementation-by-spec/024-firehose/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to Firehose.
