...
You are completing the `implementation-by-spec/028-ecs/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to ECS.
