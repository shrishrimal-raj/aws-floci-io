# Codex CLI task - Auto Scaling

You are completing the `implementation-by-spec/038-auto-scaling/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to Auto Scaling.
...
docker compose up -d
pnpm install
cd implementation-by-spec/038-auto-scaling
pnpm setup
pnpm test
```
