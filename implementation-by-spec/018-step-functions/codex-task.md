# Codex CLI task - Step Functions

You are completing the `implementation-by-spec/018-step-functions/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to Step Functions.
