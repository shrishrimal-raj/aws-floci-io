# Codex CLI task - Lambda

You are completing the `implementation-by-spec/006-lambda/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to Lambda.
