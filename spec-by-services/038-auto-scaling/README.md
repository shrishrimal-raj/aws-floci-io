# 038 - Auto Scaling (Spec)

> EC2/ECS scaling policies. Target tracking, step scaling.
...
## What it is
Auto Scaling is an AWS compute service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to Auto Scaling
- Use case 2 specific to Auto Scaling
- Use case 3 specific to Auto Scaling
...
export const client = new AutoScalingClient(awsDefaults());
```
...
## Related services
- [006 - Lambda](../006-lambda/README.md)
