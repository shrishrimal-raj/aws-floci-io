...
> Container orchestration. Fargate or EC2.
...
## What it is
ECS is an AWS containers service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to ECS
- Use case 2 specific to ECS
- Use case 3 specific to ECS
...
export const client = new ECSClient(awsDefaults());
```
