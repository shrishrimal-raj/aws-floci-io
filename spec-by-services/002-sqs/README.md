...
> Managed message queues. Standard + FIFO. Visibility timeout, DLQs.
...
## What it is
SQS is an AWS messaging service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to SQS
- Use case 2 specific to SQS
- Use case 3 specific to SQS
...
export const client = new SQSClient(awsDefaults());
```
