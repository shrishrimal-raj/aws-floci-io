# Codex CLI task - Kinesis Data Streams

You are completing the `implementation-by-spec/023-kinesis/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to Kinesis Data Streams.
