# Codex CLI - Project 002: Queue-Based Order Processing System

Build the project described in `spec-by-phases/phase-10-capstone/projects/002-queue-based-order-system.md`.
