# Codex CLI - Phase 09: AI, Documents, Specialized Services

Implement the full phase as described in `spec-by-phases/phase-09-ai-specialized/README.md`.
...
2. Build the major project: **AI Document Intelligence Backend**.
