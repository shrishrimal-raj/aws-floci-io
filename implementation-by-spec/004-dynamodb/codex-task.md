# Codex CLI task - DynamoDB

You are completing the `implementation-by-spec/004-dynamodb/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to DynamoDB.
