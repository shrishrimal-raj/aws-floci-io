# Codex CLI task - SSM Parameter Store

You are completing the `implementation-by-spec/014-ssm-parameter-store/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to SSM Parameter Store.
