...
You are completing the `implementation-by-spec/011-sts/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to STS.
