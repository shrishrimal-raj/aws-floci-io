...
> Your team is building lightweight http apis. cheaper, faster, fewer features than v1. You own the integration. Design + implement + test + document the module so a teammate can use it next week without asking you questions. Deliverables: module code, tests, README, runbook.
