# Codex CLI task - DynamoDB Streams

You are completing the `implementation-by-spec/005-dynamodb-streams/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to DynamoDB Streams.
