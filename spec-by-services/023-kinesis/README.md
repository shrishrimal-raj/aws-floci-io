# 023 - Kinesis Data Streams (Spec)

> Real-time streaming. Shards, partition keys, consumers.
...
## What it is
Kinesis Data Streams is an AWS streaming service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to Kinesis Data Streams
- Use case 2 specific to Kinesis Data Streams
- Use case 3 specific to Kinesis Data Streams
...
export const client = new KinesisClient(awsDefaults());
```
