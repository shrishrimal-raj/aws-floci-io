# Codex CLI task - CloudWatch Logs

You are completing the `implementation-by-spec/019-cloudwatch-logs/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to CloudWatch Logs.
