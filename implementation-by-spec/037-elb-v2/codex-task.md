# Codex CLI task - ELB v2 (ALB/NLB)

You are completing the `implementation-by-spec/037-elb-v2/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to ELB v2 (ALB/NLB).
...
docker compose up -d
pnpm install
cd implementation-by-spec/037-elb-v2
pnpm setup
pnpm test
```
