# Codex CLI task - Route53

You are completing the `implementation-by-spec/039-route53/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to Route53.
...
docker compose up -d
pnpm install
cd implementation-by-spec/039-route53
pnpm setup
pnpm test
```
