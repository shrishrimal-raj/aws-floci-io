# Codex CLI task - RDS Postgres

You are completing the `implementation-by-spec/025-rds-postgres/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to RDS Postgres.
