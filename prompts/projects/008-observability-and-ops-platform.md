# Codex CLI - Project 008: Search & Recommendation Backend

Build the project described in `spec-by-phases/phase-10-capstone/projects/008-observability-and-ops-platform.md`.
