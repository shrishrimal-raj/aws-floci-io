# Codex CLI task - Cognito

You are completing the `implementation-by-spec/009-cognito/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to Cognito.
