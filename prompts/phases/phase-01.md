# Codex CLI - Phase 01: Core Backend Services

Implement the full phase as described in `spec-by-phases/phase-01-core-backend/README.md`.
...
2. Build the major project: **TaskFlow API**.
