...
> Serverless SQL over S3. Trino-based.
...
## What it is
Athena is an AWS analytics service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to Athena
- Use case 2 specific to Athena
- Use case 3 specific to Athena
...
export const client = new AthenaClient(awsDefaults());
```
