# 017 - EventBridge Pipes (Spec)

> Source → filter → enrich → target without Lambda glue.
...
## What it is
EventBridge Pipes is an AWS events service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to EventBridge Pipes
- Use case 2 specific to EventBridge Pipes
- Use case 3 specific to EventBridge Pipes
...
export const client = new PipesClient(awsDefaults());
```
