...
> Virtual machines. AMIs, instance types, security groups.
...
## What it is
EC2 is an AWS compute service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to EC2
- Use case 2 specific to EC2
- Use case 3 specific to EC2
...
export const client = new EC2Client(awsDefaults());
```
