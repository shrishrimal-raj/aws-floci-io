# Codex CLI task - API Gateway v1 (REST)

You are completing the `implementation-by-spec/007-api-gateway-v1/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to API Gateway v1 (REST).
