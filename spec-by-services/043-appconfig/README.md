...
> Feature flags + dynamic config with validation.
...
## What it is
AppConfig is an AWS ops service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to AppConfig
- Use case 2 specific to AppConfig
- Use case 3 specific to AppConfig
...
export const client = new AppConfigClient(awsDefaults());
```
