...
> Serverless NoSQL key-value + document. Single-table design.
...
## What it is
DynamoDB is an AWS database service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to DynamoDB
- Use case 2 specific to DynamoDB
- Use case 3 specific to DynamoDB
...
export const client = new DynamoDBClient(awsDefaults());
```
