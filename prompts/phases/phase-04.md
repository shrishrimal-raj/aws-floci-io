# Codex CLI - Phase 04: Advanced Serverless & Event Systems

Implement the full phase as described in `spec-by-phases/phase-04-advanced-events/README.md`.
...
2. Build the major project: **Event-Driven Commerce Core**.
