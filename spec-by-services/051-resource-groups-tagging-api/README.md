# 051 - Resource Groups Tagging API (Spec)

> Tag-based resource queries across services.
...
## What it is
Resource Groups Tagging API is an AWS ops service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to Resource Groups Tagging API
- Use case 2 specific to Resource Groups Tagging API
- Use case 3 specific to Resource Groups Tagging API
...
export const client = new ResourceGroupsTaggingAPIClient(awsDefaults());
```
