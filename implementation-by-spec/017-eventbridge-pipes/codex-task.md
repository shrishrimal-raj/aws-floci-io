# Codex CLI task - EventBridge Pipes

You are completing the `implementation-by-spec/017-eventbridge-pipes/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to EventBridge Pipes.
