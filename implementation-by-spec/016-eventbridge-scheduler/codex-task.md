# Codex CLI task - EventBridge Scheduler

You are completing the `implementation-by-spec/016-eventbridge-scheduler/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to EventBridge Scheduler.
