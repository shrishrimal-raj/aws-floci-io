# Codex CLI task - Textract

You are completing the `implementation-by-spec/045-textract/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to Textract.
...
docker compose up -d
pnpm install
cd implementation-by-spec/045-textract
pnpm setup
pnpm test
```
