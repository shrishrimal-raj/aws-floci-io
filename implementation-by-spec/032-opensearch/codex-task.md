# Codex CLI task - OpenSearch

You are completing the `implementation-by-spec/032-opensearch/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to OpenSearch.
