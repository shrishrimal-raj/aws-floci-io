# Codex CLI task - CloudFormation

You are completing the `implementation-by-spec/035-cloudformation/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to CloudFormation.
