...
You are completing the `implementation-by-spec/001-s3/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to S3.
