# Codex CLI task - EventBridge

You are completing the `implementation-by-spec/015-eventbridge/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to EventBridge.
