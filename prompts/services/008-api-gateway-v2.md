# Codex CLI task - API Gateway v2 (HTTP)

You are completing the `implementation-by-spec/008-api-gateway-v2/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to API Gateway v2 (HTTP).
