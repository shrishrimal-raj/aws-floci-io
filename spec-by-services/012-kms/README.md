...
> Encryption keys. CMKs, data keys, envelope encryption.
...
## What it is
KMS is an AWS security service used in production backends for the use cases listed below.

## Real-world backend use cases
- Use case 1 specific to KMS
- Use case 2 specific to KMS
- Use case 3 specific to KMS
...
export const client = new KMSClient(awsDefaults());
```
