# Codex CLI task - ElastiCache Redis

You are completing the `implementation-by-spec/026-elasticache-redis/` folder for an AWS + Floci learning monorepo.
...
2. **`src/use-cases/`** - at least two production patterns specific to ElastiCache Redis.
